...
#define MQTT_DEVICE "gameroom-rgb-right" // Enter your MQTT device
...
#define ROOM_LIGHT_COMMAND_TOPIC "gameroom/rgb_right/light/switch"

// brightness
#define ROOM_LIGHT_BRIGHTNESS_STATE_TOPIC "gameroom/rgb_right/brightness/status"
#define ROOM_LIGHT_BRIGHTNESS_COMMAND_TOPIC "gameroom/rgb_right/brightness/set"

// colors (rgb)
#define ROOM_LIGHT_RGB_STATE_TOPIC "gameroom/rgb_right/rgb/status"
#define ROOM_LIGHT_RGB_COMMAND_TOPIC "gameroom/rgb_right/rgb/set"
